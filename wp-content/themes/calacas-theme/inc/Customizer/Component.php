<?php
/**
 * WP_Calacas\WP_Calacas\Customizer\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Customizer;
...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'calacas-theme' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'calacas-theme-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			array( 'customize-preview' ),
			calacas_theme()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}

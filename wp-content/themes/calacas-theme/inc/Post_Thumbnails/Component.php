<?php
/**
 * WP_Calacas\WP_Calacas\Post_Thumbnails\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Post_Thumbnails;
...
class Component implements Component_Interface {
	...
	public function action_add_image_sizes() {
		add_image_size( 'calacas-theme-featured', 720, 480, true );
		add_image_size( 'full', 1200, 750 );
	}
}

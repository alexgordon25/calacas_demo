<?php
/**
 * WP_Calacas\WP_Calacas\Comments\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Comments;
 ...
 * * `calacas_theme()->the_comments( array $args = [] )`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function the_comments( array $args = array() ) {
		...
		$amp_live_list = calacas_theme()->using_amp_live_list_comments();
		...
		if ( $amp_live_list ) {
			...
			?>
				<div update>
					<button class="button" on="tap:amp-live-comments-list-<?php the_ID(); ?>.update"><?php esc_html_e( 'New comment(s)', 'calacas-theme' ); ?></button>
				</div>
			</amp-live-list>
			<?php
		}

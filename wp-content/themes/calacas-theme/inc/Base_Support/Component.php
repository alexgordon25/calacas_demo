<?php
/**
 * WP_Calacas\WP_Calacas\Base_Support\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Base_Support;
 ...
 * * `calacas_theme()->get_version()`
 * * `calacas_theme()->get_asset_version( string $filepath )`
 */

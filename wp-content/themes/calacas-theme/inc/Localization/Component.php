<?php
/**
 * WP_Calacas\WP_Calacas\Localization\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Localization;
...
class Component implements Component_Interface {
	...
	public function action_load_textdomain() {
		 ...
		 */
		load_theme_textdomain( 'calacas-theme', $this->translation_directory );
	}
}

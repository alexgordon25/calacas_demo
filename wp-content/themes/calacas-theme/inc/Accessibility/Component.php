<?php
/**
 * WP_Calacas\WP_Calacas\Accessibility\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Accessibility;
...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			'calacas-theme-navigation',
			get_theme_file_uri( '/assets/js/navigation.min.js' ),
			array(),
			calacas_theme()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			false
		);
		wp_script_add_data( 'calacas-theme-navigation', 'async', true );
		wp_script_add_data( 'calacas-theme-navigation', 'precache', true );
		wp_localize_script(
			'calacas-theme-navigation',
			'calacasThemeScreenReaderText',
			[
				'expand'   => __( 'Expand child menu', 'calacas-theme' ),
				'collapse' => __( 'Collapse child menu', 'calacas-theme' ),
			]
		);
	}

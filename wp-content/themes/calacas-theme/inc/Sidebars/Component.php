<?php
/**
 * WP_Calacas\WP_Calacas\Sidebars\Component class
 *
 * @package calacas_theme
 */

namespace WP_Calacas\WP_Calacas\Sidebars;
 ...
 * * `calacas_theme()->is_primary_sidebar_active()`
 * * `calacas_theme()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Sidebar', 'calacas-theme' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'calacas-theme' ),

<?php
/**
 * WP_Rig\WP_Rig\Foreground_Video\Component class
 *
 * @package wp_rig
 */

namespace WP_Rig\WP_Rig\Foreground_Video;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function display_foreground_video_trigger( $foreground_video_id, $foreground_video_trigger, $block_id, $trigger_animations = array() ) {
		$t_icon                = wp_rig()->arr2str( $foreground_video_trigger['icon'] );
		$t_icon_color          = $foreground_video_trigger['icon_color'];
		$t_icon_label          = $foreground_video_trigger['icon_label'];
		$t_icon_label_position = wp_rig()->arr2str( $foreground_video_trigger['icon_label_position'] );
		$t_icon_position       = wp_rig()->arr2str( $foreground_video_trigger['icon_position'] );
		...
		if ( $foreground_video_id ) :
			...
			<div class="video-trigger" data-target="<?php echo esc_attr( '#v-' . $foreground_video_id ); ?>">
				...
				wp_rig()->set_scroll_animation( $trigger_animations );
				?>
					<div class="btn-icon">
